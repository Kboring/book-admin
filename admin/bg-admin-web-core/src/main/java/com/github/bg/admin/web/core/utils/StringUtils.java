package com.github.bg.admin.web.core.utils;
...
public class StringUtils {
    ...
    public static String getSplitData(String str, String split, int idx) {
        if (com.github.bg.admin.web.core.utils.StringUtils.isEmpty(str)) {
            return "";
        }
        String resStr = "";
    ...
    public static String toParaLen(int len) {
        ...
        //补0后进行高低位调换
        a = com.github.bg.admin.web.core.utils.StringUtils.addZeroLeft(a, 8);
