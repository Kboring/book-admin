...
public class TreeController {
    ...
    @RequestMapping("getTreeByTreeName")
    public ReturnInfo getTreeByTreeName() {
        return treeService.getTreeByTreeName();
    }

    @RequestMapping("getTreeByTreeId")
    public ReturnInfo getTreeByTreeId() {
        return treeService.getTreeByTreeId();
    }

    @RequestMapping("getTreeByCategoryId")
    public ReturnInfo getTreeByCategoryId() {
        return treeService.getTreeByCategoryId();
    }

    @RequestMapping("getTreeByCategoryIdNot0")
    public ReturnInfo getTreeByCategoryIdNot0() {
        return treeService.getTreeByCategoryIdNot0();
    }

    @RequestMapping("addFirstTree")
    public ReturnInfo addFirstTree(@RequestParam(name = "firstName") String firstName,
                                   @RequestParam(name = "parentTreeId") String parentTreeId) {
        return treeService.addFirstTree(firstName,parentTreeId);
    }

    @RequestMapping("updateFirstTree")
    public ReturnInfo updateFirstTree(@RequestParam(name = "firstName") String firstName,
                                      @RequestParam(name = "parentTreeId")String parentTreeId) {
        return treeService.updateFirstTree(firstName,parentTreeId);
    }

    @RequestMapping("deleteFirstTree")
    public ReturnInfo deleteFirstTree(@RequestParam(name = "index") String index) {
        return treeService.deleteFirstTree(index);
    }

    @RequestMapping("deleteSecondTree")
    public ReturnInfo deleteSecondTree(@RequestParam(name = "index") String index) {
        return treeService.deleteSecondTree(index);
    }
